...
namespace EasyIMGUI.Controls.Base
{
    ...
    public abstract class NestedControl : Control
    {
        ...
        /// Each <see cref="Control"/>'s <see cref="Control.Draw"/> method in invoked in <see cref="NestedControl.Draw"/>
        /// </summary>
        public List<Control> Controls { get; } = new List<Control>();
        /// <summary>
        /// Invokes each <see cref="NestedControl.Controls"/>'s <see cref="Control.Draw"/> method.
